...
class InstructionMemory(implicit val conf:Configurations) extends Module{
  ...
  memory.write(0.U, "b00000000101000000000000010010011".U(32.W))
  memory.write(4.U, "b00000000000100000000000100010011".U(32.W))
  memory.write(8.U, "b00000000000100010100011001100011".U(32.W))
  memory.write(12.U, "b00000000000000001000000100010011".U(32.W))
  memory.write(16.U, "b00000010100000000000000001101111".U(32.W))
  memory.write(20.U, "b00000000000100000000000100010011".U(32.W))
  memory.write(24.U, "b00000000000100000000000110010011".U(32.W))
  memory.write(28.U, "b00000000001000000000001000010011".U(32.W))
  memory.write(32.U, "b00000000000100100101110001100011".U(32.W))
  memory.write(36.U, "b00000000000000010000001010010011".U(32.W))
  memory.write(40.U, "b00000000001100010000000100110011".U(32.W))
  memory.write(44.U, "b00000000000000101000000110010011".U(32.W))
  memory.write(48.U, "b00000000000100100000001000010011".U(32.W))
  memory.write(52.U, "b11111110110111111111000001101111".U(32.W))
  memory.write(56.U, "b00000000000000010000001100010011".U(32.W))
  memory.write(60.U, "b00000000011000000010000000100011".U(32.W))
