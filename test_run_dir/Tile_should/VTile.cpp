...
void VTile::_settle__TOP__1(VTile__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_alu_fun 
    ...
    vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op1 
        = ((0U == ((0x2003U == (0x707fU & vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI))
            ...
            ? ((0U != (0x1fU & (vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI 
               ...
               [(0x1fU & (vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI 
                          >> 0xfU))] : 0U) : vlTOPp->Tile__DOT__core__DOT__dpath__DOT__pc_execute);
    vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_imm_sel 
        = ((0x2003U == (0x707fU & vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI))
            ? 1U : ((3U == (0x707fU & vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI))
                     ? 1U : ((0x4003U == (0x707fU & vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI))
                              ? 1U : ((0x1003U == (0x707fU 
    ...
    vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op2 
        = ((0U == ((0x2003U == (0x707fU & vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI))
            ...
            ? ((0U != (0x1fU & (vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI 
               ...
               [(0x1fU & (vlTOPp->Tile__DOT__bram__DOT__syncmemblackbox_rdataI 
                          >> 0x14U))] : 0U) : ((4U 
                                                == (IData)(vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_imm_sel))
                                                ? (
                                                   (((0x80000000U 
                                                      ...
                                                      ((((0x80000000U 
                                                       ...
                                                       | (0xfffU 
                                                          & (vlTOPp->Tile__DOT__core__DOT__dpath__DOT__inst_execute 
                                                             >> 0x14U)))
                                                       : 0U))))));
    vlTOPp->io_debug_alu_out = ((0xcU == (IData)(vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_alu_fun))
                                 ? vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op2
                                 : ((0xbU == (IData)(vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_alu_fun))
                                     ? vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op1
                                     : ((4U == (IData)(vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_alu_fun))
                                         ? (vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op1 
                                            >> (0x1fU 
                                                & vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op2))
                                         : ((5U == (IData)(vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_alu_fun))
                                             ? VL_SHIFTRS_III(32,32,5, vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op1, 
                                                              (0x1fU 
                                                               & vlTOPp->Tile__DOT__core__DOT__dpath__DOT__aLU_io_op2))
                                             : ((3U 
                                                 == (IData)(vlTOPp->Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_alu_fun))
                                                 ? (IData)(
...
void VTile::_ctor_var_reset() {
    ...
    Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_imm_sel = VL_RAND_RESET_I(3);
    Tile__DOT__core__DOT__dpath__DOT__ctrlUnit_io_ctrlEX_alu_fun = VL_RAND_RESET_I(4);
